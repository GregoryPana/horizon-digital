        ...
        <ul className="flex flex-col items-start gap-4 lg:flex-row lg:items-center lg:gap-6 xl:gap-10">
          {navLinks.map((item) => (
            <li key={item.path} className="list-none">
              ...
              >
                <span className="relative z-10 block whitespace-nowrap px-3 py-2 text-xs uppercase tracking-[0.18em] transition-colors duration-300 group-hover:text-accent">
                  {item.label}
                </span>
