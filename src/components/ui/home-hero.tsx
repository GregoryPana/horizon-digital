    ...
    <section id="top" className="relative h-[90svh] w-full overflow-hidden bg-bg text-text md:h-svh">
      ...
      <div className="relative z-10 flex h-[90svh] w-full items-center justify-center px-5 md:h-svh md:px-8">
        <div className="-translate-y-[7%] text-center md:translate-y-[6%]">
          <p className="brand-name hero-brand-glow -translate-y-[10%] text-[2.55rem] uppercase tracking-[0.13em] text-accent sm:text-6xl md:-translate-y-1/4 md:text-[clamp(2.35rem,5.4vw,4rem)] md:tracking-[0.2em]">
            <span className="block md:inline">Horizon</span>
            <span className="block md:ml-[0.35em] md:inline">Digital</span>
          </p>
          <p className="hero-main-subtext mx-auto mt-7 max-w-[93vw] translate-y-[30%] px-1 text-[0.97rem]/[1.62] font-medium tracking-tight text-text/80 md:mt-14 md:max-w-xl md:translate-y-0 md:px-0 md:text-base/7 md:font-light">
          ...
          <div className="mt-9 flex w-full translate-y-[32%] flex-col items-stretch justify-center gap-3.5 sm:mt-12 sm:translate-y-[47%] sm:flex-row sm:items-center sm:gap-6 md:translate-y-0">
