  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-[90svh] w-full items-center justify-center px-6 md:h-svh md:px-8">
        <div className="translate-y-[14%] text-center md:translate-y-[6%]">
          <p
            ref={h1Ref}
            className="hero-brand-glow -translate-y-[15%] text-5xl font-semibold uppercase tracking-[0.14em] text-accent sm:text-6xl md:-translate-y-1/4 md:text-[clamp(2.35rem,5.4vw,4rem)] md:tracking-[0.2em]"
          >
          ...
          <p
            ref={pRef}
            className="hero-main-subtext mx-auto mt-5 max-w-[92vw] translate-y-[2%] text-[0.82rem]/6 font-semibold tracking-tight text-text/80 md:mt-10 md:max-w-xl md:translate-y-0 md:text-base/7 md:font-light"
          >
