        ...
        <div className="footer-content grid gap-16 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <a
                className="flex w-fit items-center gap-3 text-sm text-text-muted transition hover:text-cyan"
              ...
              >
                <div className="p-1.5 rounded-md bg-white/5 border border-white/10">
                  <svg viewBox="0 0 24 24" aria-hidden="true" className="h-3.5 w-3.5 text-cyan">
              ...
              <a
                className="group flex w-fit items-center gap-3 text-sm text-text-muted transition hover:text-cyan"
              ...
              >
                ...
                <span>Chat on <span className="font-medium text-text transition-colors group-hover:text-cyan">WhatsApp</span></span>
              </a>
            </div>
          </div>
        </div>
