...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        display: ['"Gambetta Variable"', 'serif'],
        sans: ['Questrial', 'system-ui', 'sans-serif'],
      },
      fontSize: {
        'display-cinematic': ['clamp(60px, 11vw, 120px)', { lineHeight: '1.05', letterSpacing: '-0.01em' }],
        'display-hero': ['clamp(48px, 8vw, 92px)', { lineHeight: '1.1', letterSpacing: '-0.005em' }],
        'display-xl': ['clamp(36px, 6vw, 64px)', { lineHeight: '1.15', letterSpacing: '0' }],
        'display-lg': ['clamp(30px, 5vw, 52px)', { lineHeight: '1.2', letterSpacing: '0' }],
        'display-md': ['clamp(22px, 4vw, 40px)', { lineHeight: '1.25', letterSpacing: '0.01em' }],
