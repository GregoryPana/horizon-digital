...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        'display-cinematic': ['clamp(52px, 9vw, 100px)', { lineHeight: '1.05', letterSpacing: '-0.01em' }],
        'display-hero': ['clamp(40px, 7vw, 80px)', { lineHeight: '1.1', letterSpacing: '-0.005em' }],
        'display-xl': ['clamp(30px, 5vw, 52px)', { lineHeight: '1.15', letterSpacing: '0' }],
        'display-lg': ['clamp(26px, 4vw, 44px)', { lineHeight: '1.2', letterSpacing: '0' }],
        'display-md': ['clamp(20px, 3vw, 32px)', { lineHeight: '1.25', letterSpacing: '0.01em' }],
        'display-sm': ['20px', { lineHeight: '1.3' }],
